...
public class BookAppoint extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bookDoctor = findViewById(R.id.nbtnBookDoctor);
        Button ViewDoctor=findViewById(R.id.nbtnViewDoctor);
        doctorslist = findViewById(R.id.nspin_doctor);
        petlist=findViewById(R.id.nspin_pet);

        Spinner apptime=findViewById(R.id.nspinTime);
        ...
        bookDoctor.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Cursor c1 = myDb.rawQuery("select opentime,closetime from doctorschedule where did=1",null);
                c1.moveToFirst();
        ...
        ViewDoctor.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i3=new Intent(BookAppoint.this,ViewCustomerDoctorAppointment.class);
